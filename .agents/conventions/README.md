...
- Crie um arquivo Markdown por assunto, com nome curto e descritivo, como `backend.md`,
  `frontend.md`, `testes.md` ou `integracoes.md`.
...
- Registre apenas decisões confirmadas e reutilizáveis; não registre hipóteses, segredos,
  IDs de execução ou detalhes temporários.
