...
export const CONFIG_TEXTS: Record<string, ConfigText> = {
  ...
  'review.execution_mode': { label: 'Forma de chamar o agente', description: 'A revisão é executada pelo Herdr em modo nativo de agentes.', hint: 'O Herdr cria um pane isolado e aguarda o término do agente.' },
...
export const OPTION_TEXTS: Record<string, Record<string, OptionText>> = {
  ...
  'review.execution_mode': { herdr: { label: 'Herdr', tooltip: 'Executa o agente em pane isolado via modo nativo de agentes do Herdr.', recommended: true } },
