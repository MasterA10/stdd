...
- Quando for necessário usar subagentes, eles podem ser executados no Herdr (modo nativo de agentes), mas pergunte ao usuário antes de iniciar. Se o usuário disser claramente que quer usar subagentes, considere essa autorização dada e use o Herdr; não ofereça `terminal` como alternativa para subagentes.
